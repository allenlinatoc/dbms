...
-- -----------------------------------------------------
-- Table `dbass`.`d_student_course`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbass`.`d_student_course` ;

CREATE TABLE IF NOT EXISTS `dbass`.`d_student_course` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `student_id` INT UNSIGNED NOT NULL,
  `course_id` INT UNSIGNED NOT NULL,
  `sy_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `dbass`.`notifications`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbass`.`notifications` ;

CREATE TABLE IF NOT EXISTS `dbass`.`notifications` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `type` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `dbass`.`notifications_student`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbass`.`notifications_student` ;

CREATE TABLE IF NOT EXISTS `dbass`.`notifications_student` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Placeholder table for view `dbass`.`v_notifications`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbass`.`v_notifications` (`id` INT, `type` INT, `datetime` INT, `text` INT, `targetrelpath` INT, `course_id` INT);

-- -----------------------------------------------------
-- Placeholder table for view `dbass`.`v_notifications_student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbass`.`v_notifications_student` (`id` INT, `type` INT, `datetime` INT, `text` INT, `targetrelpath` INT, `course_id` INT, `student_id` INT);
...
USE `dbass`;
DROP procedure IF EXISTS `dbass`.`addStudentCourseEntry`;
...
USE `dbass`;
DROP procedure IF EXISTS `dbass`.`banStudentCourseEntry`;
...
USE `dbass`;
DROP procedure IF EXISTS `dbass`.`deleteStudentCourseEntry`;
...
-- -----------------------------------------------------
-- View `dbass`.`v_notifications`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `dbass`.`v_notifications` ;
DROP TABLE IF EXISTS `dbass`.`v_notifications`;
USE `dbass`;
...
-- -----------------------------------------------------
-- View `dbass`.`v_notifications_student`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `dbass`.`v_notifications_student` ;
DROP TABLE IF EXISTS `dbass`.`v_notifications_student`;
USE `dbass`;
...
USE `dbass`$$
DROP TRIGGER IF EXISTS `dbass`.`THREAD_AI` $$
USE `dbass`$$
...
USE `dbass`$$
DROP TRIGGER IF EXISTS `dbass`.`thread_au` $$
USE `dbass`$$
...
USE `dbass`$$
DROP TRIGGER IF EXISTS `dbass`.`d_student_course_ai` $$
USE `dbass`$$
...
USE `dbass`$$
DROP TRIGGER IF EXISTS `dbass`.`d_student_course_au` $$
USE `dbass`$$
...
USE `dbass`$$
DROP TRIGGER IF EXISTS `dbass`.`d_student_course_ad` $$
USE `dbass`$$
